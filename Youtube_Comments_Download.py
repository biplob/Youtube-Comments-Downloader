...
video_to_scrape = "https://www.youtube.com/watch?v=qsdRHwjdvlA&t=1187s"
chrome_path = "C:/Users/user/Downloads/chromedriver-win64/chromedriver.exe"
...
df.index.name = 'Index'
df.to_csv('youtube_commentswith_500_company_replies.csv', index=True)
